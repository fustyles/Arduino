/*
ESP32-CAM DeepLab
Author : ChungYi Fu (Kaohsiung, Taiwan)  2019-11-8 01:30
    ...
    <body>
        <section class="main">
            ...
            <section id="buttons">
                ...
                <tr><td colspan="3"><button id="get-still" style="display:none">Semantic Image Segmentation (DeepLab)</button></td></tr>
                ...
                <tr><td colspan="3"><canvas id="canvas" width="0" height="0"></canvas><div id="legendList"></div></td></tr>
                <tr><td colspan="3"><br><div id="result">Please wait for loading model.<div></td></tr>
                </table>
            </section>
            <div id="logo">
