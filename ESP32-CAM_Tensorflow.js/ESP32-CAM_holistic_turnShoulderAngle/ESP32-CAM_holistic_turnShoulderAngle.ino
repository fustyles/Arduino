/*
ESP32-CAM Mediapipe Holistic 旋轉肩膀角度
...
<html>
    ...
    function onResults(results) {
      ...
      //肩膀X軸旋轉角度
      var rightShoulderX4y = (holistic_pose_position("12", "y"));
      var rightShoulderX4z = (holistic_pose_position("12", "z"));
      var leftShoulderX4y = (holistic_pose_position("11", "y"));
      ...
      leftShoulderY4z = (holistic_pose_position("11", "z"));
      rotateAngleY = (holistic_angle(rightShoulderY4x, rightShoulderY4z, leftShoulderY4x, leftShoulderY4z));
      if (rotateAngleY) {
