/*
ESP32-CAM teachablemachine
Open the page in Chrome.
Author : ChungYi Fu (Kaohsiung, Taiwan)  2020-7-26 21:00
...
<html>
    ...
    <body>
        <section class="main">
            ...
            <section id="buttons">
                ...
                <tr><td><button id="get-still" style="display:none">Get Still</button></td><td align="center" colspan="2"><button type="button" onclick="ObjectDetect();">Start Recognition</button></td></tr>
    ...
    async function predict() {
      ...
      var maxClassName = "";
      var maxProbability = "";
      const prediction = await Model.predict(ShowImage);
      if (maxPredictions>0) {
