            ...
            if (Predictions[i].class=="person"&&Predictions[i].score>=0.5&&trackState==0) {   
              try{
                ...
                if (midX>(30+320/2))
                  ...
                  angle1Value1+=175;
                if (angle1Value1 > 7825)
                  angle1Value1 = 7825;
                else if (angle1Value1 < 1875)
                  angle1Value1 = 1875; 
                console.log(angle1Value1);
                fetch(document.location.origin+'/control?var=servo1&val='+angle1Value1); 
                ...
                if (midY>(30+240/2))
                  ...
                  angle1Value2+=175;
                if (angle1Value2 > 7825)
                  angle1Value2 = 7825;
                else if (angle1Value2 < 1875)
                  angle1Value2 = 1875;
                console.log(angle1Value2);
                fetch(document.location.origin+'/control?var=servo2&val='+angle1Value2);                   
              }
              catch(e){}
            }  
          }
