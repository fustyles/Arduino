...
Author : ChungYi Fu (Kaohsiung, Taiwan)  2020-7-1 00:00
...
<html>
    ...
    <body>
        <section class="main">
            <section id="buttons">
                <table>
                <tr><td><button id="get-still">Get Still</button></td><td style="display:none"><button id="toggle-stream"></button></td><td></td></tr>
    ...
    window.onload = function () { FaceMeshDetect(); }
