    ...
    <body>
        <section class="main">
            <section id="buttons">
                ...
                <tr><td>MirrorImage<select id="mirrorimage"><option value="1">Y</option><option value="0">N</option></select></td><td><button id="toggle-stream"></button></td><td><button id="face_enroll" class="disabled" disabled="disabled"></button></td></tr>
