...
Author : ChungYi Fu (Kaohsiung, Taiwan)  2019-11-3 23:00
...
<html>
    ...
    <body>
        <section class="main">
            ...
            <section id="buttons">
                <table>
                <tr><td align="center"><button id="get-still">Get Still</button></td><td><button onclick="SendCapturedImage();">Send Captured Image</button><button id="toggle-stream" style="display:none">Start Stream</button></td><td><button id="face_enroll" class="disabled" disabled="disabled" style="display:none">Enroll Face</button></td></tr>
            ...
            <figure>
              <form id="myForm" action="" method="post" target="sendcapturedimage">
                Google Script Url : <input type="text" id="myGoogleScript" name="myGoogleScript" value="https://script.google.com/macros/s/xxxxxxxxxxxxxxxxxxxx/exec"><br>
                Gmail Recipient: <input type="text" id="myRecipient" name="myRecipient" value="xxxxx@gmail.com"><br>
                Gmail Subject: <input type="text" id="mySubject" name="mySubject" value="Hello World"><br>
        ...
        <script>
          ...
          function SendCapturedImage() {
            // Upload captured image to Google App Script.
