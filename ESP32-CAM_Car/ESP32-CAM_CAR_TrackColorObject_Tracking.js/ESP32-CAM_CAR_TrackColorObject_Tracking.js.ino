/*
ESP32-CAM Following Car with Color Recognition (Tracking.js)

Author : ChungYi Fu (Kaohsiung, Taiwan)  2021-7-11 14:00
...
<head>
    ...
    <figure>
      <div id="stream-container" class="image-container hidden">
        ...
        <canvas id="canvas" width="0" height="0"></canvas><canvas id="canvas_pixel" style="display:none;"></canvas>
      </div>
    </figure>
      <section id="buttons">
              <table>
