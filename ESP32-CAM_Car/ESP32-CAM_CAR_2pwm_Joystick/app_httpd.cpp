...
Author : ChungYi Fu (Kaohsiung, Taiwan)  2020-8-20 00:30
        ...
        <script type="text/javascript">
          ...
          setInterval(function(){ 
            if (Joy3.GetDir()=="N"&&carState!="N") {
              ...
              carState="SW";
              fetch(document.location.origin+'/control?var=car&val=8');
            }
            else if (Joy3.GetDir()=="SE"&&carState!="SE") {
              carState="SE";
              fetch(document.location.origin+'/control?var=car&val=9');
            }
