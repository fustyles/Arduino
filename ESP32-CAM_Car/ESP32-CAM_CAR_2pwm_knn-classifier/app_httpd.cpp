      ...
      <div id="stream-container" class="image-container hidden">
        ...
        <section class="main">
            <section id="buttons">
                ...
                <tr><td><input type="checkbox" id="nostop" onclick="var noStop=0;if (this.checked) noStop=1;try{fetch(document.location.origin+'/control?var=nostop&val='+noStop);}catch(e){}">No Stop(0)</td><td align="center"><button align="center" id="forward" onclick="try{fetch(document.location.origin+'/control?var=car&val=1');}catch(e){}">Forward(1)</button></td><td></td></tr>
                <tr><td><button id="turnleft" align="center" onclick="try{fetch(document.location.origin+'/control?var=car&val=2');}catch(e){}">TurnLeft(2)</button></td><td align="center"><button id="stop" align="center" onclick="try{fetch(document.location.origin+'/control?var=car&val=3');}catch(e){}">Stop(3)</button></td><td align="center"><button id="turnright" onclick="try{fetch(document.location.origin+'/control?var=car&val=4');}catch(e){}">TurnRight(4)</button></td></tr>
                <tr><td></td><td align="center"><button id="backward" onclick="try{fetch(document.location.origin+'/control?var=car&val=5');}catch(e){}">Backward(5)</button></td><td></td></tr>                   
