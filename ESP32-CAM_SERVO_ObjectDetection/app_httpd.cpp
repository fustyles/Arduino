...
Author : ChungYi Fu (Kaohsiung, Taiwan)  2019-5-31 22:00
    ...
    <body>
        <section class="main">
            <section id="buttons">
                ...
                <tr><td colspan="3"><button id="toggle-stream"></button><button id="face_enroll" class="disabled" disabled="disabled"></button></td></tr>
                ...
                <tr><td id="result" colspan="3"></td></tr>
                <tr><td></td></tr>
                </table>
            </section>
            <figure>
