...
SlowSoftI2CMaster si = SlowSoftI2CMaster(32, 33, true);  //ESP32 (SDA:gpio32, SCL:gpio33)
//SlowSoftI2CMaster si = SlowSoftI2CMaster(4, 5, true);  //ESP12E (SDA:gpio4, SCL:gpio5)
