...
void loop()
{
  ...
  if (gpsNewData) {
    ...
    String condinate = flat+","+flon;
    String mapURL = "https://www.google.com/maps/search/?api=1&map_action=map&zoom=16&query="+condinate;
    sendStillPrintGPSToLineNotify(lineToken, mapURL, condinate);
