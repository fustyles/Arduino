...
Author : ChungYi Fu (Kaohsiung, Taiwan)  2019-7-22 16:00
    ...
    <figure>
      <div id="stream-container" class="image-container hidden">
        ...
        <section class="main">
            <section id="buttons">
                <table>
                <tr><td align="center"><button id="get-still">Save Captures Image</button></td><td align="center"><button id="toggle-stream">Start Stream</button></td><td align="center"><button id="face_enroll" class="disabled" disabled="disabled">Enroll Face</button></td></tr>
                </table>
            </section>         
            <div id="logo">
