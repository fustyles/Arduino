...
Author : ChungYi Fu (Kaohsiung, Taiwan)  2025-8-14 13:30
...
void loop() {
  ...
  if (!audio_play.isRunning()) {
    if (speakText!="") {  
      ...
      String ttsUrl = "https://translate.google.com/translate_tts?ie=UTF-8&q=" + urlencode(speakText) + "&tl=" + googlettsLanguageCode + "&client=tw-ob";    
      speakText = "";
