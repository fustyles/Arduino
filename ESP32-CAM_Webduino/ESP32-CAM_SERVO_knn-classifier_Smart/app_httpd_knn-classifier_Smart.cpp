    ...
    <body>
          <section class="main">
            ...
            <section id="buttons">
                ...
                <tr><td></td><td><button id="demo-area-05-btn1">Forward1</button></td><td></td></tr>
                <tr><td><button id="demo-area-05-btn3">Turn Left3</button></td><td><button id="demo-area-05-btn5">Stop0</button></td><td><button id="demo-area-05-btn4">Turn Right4</button></td></tr>
                <tr><td></td><td><button id="demo-area-05-btn2">Backard2</button></td><td></td></tr>                
                </table>
            </section>          
            <div id="logo">
        ...
        <div><input type="checkbox" id="SmartGo">Smart Go</div>
          ...
          async function predictClass(img) {
            try {
              ...
              if (predict.label) {
                ...
                // Smart Car
                if ((document.getElementById('SmartGo').checked)&&(predict.confidences[predict.label]>="0.6")) {
                  if (predict.label=="0") {
                    console.log("Stop");
                    document.getElementById('SmartGo').checked = false;
                    document.getElementById('demo-area-05-btn5').click();
                  }
                    ...
                    document.getElementById('SmartGo').checked = false;
                    document.getElementById('demo-area-05-btn2').click();
                  }
                  else if (predict.label=="3") {
                    console.log("Turn Left");
                    document.getElementById('SmartGo').checked = false;
                    document.getElementById('demo-area-05-btn3').click();
                  }
                  else if (predict.label=="4") {
                    console.log("Turn Right");
                    document.getElementById('SmartGo').checked = false;
                    document.getElementById('demo-area-05-btn4').click();
                  }               
                }
              }
            }
        ...
        <script id="jsbin-javascript">
          (async function () {
          var car;
          var SmartID = "10yb9Yrbd";    //填入你的Smart ID
          
          boardReady({board: 'Smart', device: SmartID, transport: 'mqtt'}, async function (board) {
            board.samplingInterval = 50;
            car = getToyCar(board, 0, 2, 16, 14);    //填入你的Smart自走車腳位
            await delay(1);
            document.getElementById('demo-area-05-btn1').addEventListener('click',async function () {
              ...
              await delay(0.5);
              car.stop();
              document.getElementById('SmartGo').checked = true;
            });
