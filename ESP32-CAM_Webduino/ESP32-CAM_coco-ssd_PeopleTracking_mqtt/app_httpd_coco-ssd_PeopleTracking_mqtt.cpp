    ...
    <body>
        <section class="main">
            <section id="buttons">
                ...
                <tr style="display:none"><td colspan="3"><span id="angle"></span></td></tr>
        ...
        <div><input type="checkbox" id="mqtt">Start MQTT</div>
        <div id="result"><div>
        <script>
            ...
            if (Predictions[i].class=="person"&&Predictions[i].score>=score&&trackState==0) {   
              try{
                ...
                if (midX>(40+320/2)) {
                  ...
                  angle.innerHTML = (angle1Value1-1700)*180/8000+1000; 
                }
                ...
                if (midY>(240/2+30)) {
                  ...
                  angle.innerHTML = (angle1Value2-1700)*180/8000;
                }
    ...
    <script id="jsbin-javascript">
      (async function () {
        ...
        setInterval(async function () {
          var message = document.getElementById('angle').innerHTML;
