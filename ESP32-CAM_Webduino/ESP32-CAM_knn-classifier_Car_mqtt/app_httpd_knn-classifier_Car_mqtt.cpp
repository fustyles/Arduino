...
<html>
    <head>
        ...
        <script src="http://cdn.jsdelivr.net/npm/@tensorflow-models/mobilenet"></script>
        <script src="http://cdn.jsdelivr.net/npm/@tensorflow-models/knn-classifier"></script> 
        <script src="http://blocklypro.webduino.io/components/jquery/dist/jquery.min.js?rev=4a356126b9573eb7bd1e9a7494737410"></script>
        <script src="http://blocklypro.webduino.io/dist/lib/webduino-all-0.4.20.min.js?rev=4426739c00d85325cb2d3d701fa50666"></script>
        <script src="http://blocklypro.webduino.io/dist/webduino-blockly.min.js?rev=736fa9a2fba9fa461db7c329f6651493"></script>
        <script src="http://blocklypro.webduino.io/dist/lib/firebase.min.js?rev=c0bfd493efd477d098a4ae9e92b13880"></script>
        <script src="http://blocklypro.webduino.io/dist/lib/runtime.min.js?rev=683a69503433786202911b4d9f766100"></script>
    ...
    <body>
          <section class="main">
            ...
            <section id="buttons">
                <table>
                <tr style="visibility:hidden"><td colspan="3"><button id="toggle-stream">Start Stream</button><button id="face_enroll" class="disabled" disabled=""></button></td></tr>
                <tr><td><button onclick="saveModel();">Save Model</button></td><td colspan="2"><input type="file" id="getModel"></td></tr>
                ...
                <tr><td></td><td align="center"><button onclick="document.getElementById('message').innerHTML='-1';setTimeout(function(){document.getElementById('message').innerHTML=1;},200);">Forward(1)</button></td><td></td></tr>
                <tr><td><button onclick="document.getElementById('message').innerHTML='-1';setTimeout(function(){document.getElementById('message').innerHTML=3;},200);">TurnLeft(3)</button></td><td align="center"><button onclick="document.getElementById('message').innerHTML='-1';setTimeout(function(){document.getElementById('message').innerHTML=0;},200);">Stop(0)</button></td><td><button onclick="document.getElementById('message').innerHTML='-1';setTimeout(function(){document.getElementById('message').innerHTML=4;},200);">TurnRight(4)</button></td></tr>
                <tr><td></td><td align="center"><button onclick="document.getElementById('message').innerHTML='-1';setTimeout(function(){document.getElementById('message').innerHTML=2;},200);">Backard(2)</button></td><td></td></tr>
        ...
        <div><input type="checkbox" id="startdetection">Start Detection<input type="checkbox" id="mqtt">Start MQTT</div>
          ...
          getModel.onchange = function (event) {
            ...
            if (files.length>0) {
                fr.onload = function () {     
                  ...
                  var myDataset = JSON.parse(result)
            ...
            stream.onload = function (event) {
              if (document.getElementById('startdetection').checked)  predictClass_onclick();
              if (mobilenetModule) {
                try { 
