...
<html>
    ...
    <body>
        ...
        <div><input type="checkbox" id="startdetection">Start Detection<input type="checkbox" id="controlcar">Control Car</div>
        ...
        <script id="jsbin-javascript">
          (async function () {
            ...
            setInterval(async function () {
              ...
              if (document.getElementById('controlcar').checked == true&&message!="") {
