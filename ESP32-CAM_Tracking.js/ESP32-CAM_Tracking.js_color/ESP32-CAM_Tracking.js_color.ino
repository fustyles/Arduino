...
static const char PROGMEM INDEX_HTML[] = R"rawliteral(
  ...
  <td colspan="2"><input type="button" id="getStill" value="Start Detect"></td> 
  </tr>
  <tr>
    <td>Color Name</td>
    <td colspan="2"><input type="text" id="myColor" value="black"></td>
  </tr>
  <tr>
    <td>Color R </td>
    <td colspan="2">
      min
      <select id="myColor_r_min">
        <script>
        for (var i=0;i<=255 ;i++ ) {
