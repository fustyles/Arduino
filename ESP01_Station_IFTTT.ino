...
Author : ChungYi Fu (Taiwan)  2018-04-16 23:30
...
void loop() 
{
  ...
  {
    int SensorHumidity = rand()%100;     // Humidity
    int SensorTemperature = rand()%50;     // Temperature

    if ((SensorHumidity<30)||(SensorTemperature>35))
    {        
      String domain="maker.ifttt.com";
      String event="xxxxxx";
      String key="xxxxxxxxxxxxxxxxxxxx";
      String value1=String(SensorHumidity);
      String value2=String(SensorTemperature);
      String value3="";
      
      SendData("AT+CIPSTART=\"TCP\",\""+domain+"\",80", 5000);
      
      //If request length is too long, it can't work!
      String request = "GET /trigger/"+event+"/with/key/"+key+"?value1="+value1+"&value2="+value2+"&value3="+value3+" HTTP/1.1\r\nHost: "+domain+"\r\n\r\n";
