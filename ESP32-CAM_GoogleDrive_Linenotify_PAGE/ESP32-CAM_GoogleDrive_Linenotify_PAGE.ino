...
<html>
    ...
    <body>
      ...
      <tr><td colspan="3"><button id="get-still" onclick="document.getElementById('stream').src=document.location.origin+'/?getstill='+Math.random();">Stream</button><button id="stop" onclick="clearTimeout(myTimer);document.getElementById('stream').src='';">Stop</button></td></tr>
