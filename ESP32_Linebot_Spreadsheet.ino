...
String spreadsheetID = "1zztiZMyQ7HplFp0cHc0dKpiomJuStz_hFIs";
String spreadsheetName = "工作表1";

String appsScriptID = "AKfycbx-9F6o1gl6-404JBXkpiJQ0-wCyn8tFlxPXZOqiX3FdhsXkZY4jYHms";
...
void loop()
{
  ...
  if (message != "") {
    ...
    String get = (tcp_https_esp32("POST", "script.google.com", (String("/macros/s/"+appsScriptID+"/exec")+String("?response=")+String(urlencode(message))+String("&token=")+String(replyToken)), 443, 3000));
  }
  delay(1000);
}
