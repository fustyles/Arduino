...
void ExecuteCommand()
{
  ...
  if (cmd=="your cmd") {
    ...
    Feedback+="</select></td></tr><tr><td></td><td><input type=\"text\" id=\"ssid\">(Enter in manually)</td></tr><tr><td>PASSWORD</td><td><input type=\"text\" id=\"password\"></td></tr><tr><td colspan=\"2\"><input type=\"button\" value=\"Set\" onclick=\"location.href=\'?resetwifi=\'+ssid.value+\';\'+password.value;\"></td></tr></table></form>";
  }
